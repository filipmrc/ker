...
FPB = [T_bg\[FPG(:,1);1] T_bg\[FPG(:,1);1] T_bg\[FPG(:,1);1] T_bg\[FPG(:,1);1]]; %noge u COB
FPB = FPB(1:3,:);
FPL = [T_fg\[FPB(:,1);1] T_fg\[FPB(:,1);1] T_fg\[FPB(:,1);1] T_fg\[FPB(:,1);1]];
...
dLdFPL = zeros(4,12);
dLdFPL(1,1:3) = FPL(1:3)/norm(FPL(1:3)); dLdFPL(2,4:6) = FPL(4:6)/norm(FPL(4:6)); dLdFPL(3,7:9) = FPL(7:9)/norm(FPL(7:9)); dLdFPL(4,10:12) = FPL(10:12)/norm(FPL(10:12));
